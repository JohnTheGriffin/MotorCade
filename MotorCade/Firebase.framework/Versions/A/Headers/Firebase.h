...
- (FQuery *) queryWithParams:(FQueryParams *)params;
 ...
 * @param callback The block to be called after the write has been committed to the Firebase servers.
 */
- (void) set:(id)value withPriority:(id)priority onComplete:(void (^)(NSError* error))callback;
 ...
 */
- (void) removeWithOnComplete:(void (^)(NSError* error))callback;
 ...
 */
- (void) setPriority:(id)priority onComplete:(void (^)(NSError* error))callback;
...
/**
 * The same as update: with a callback block that is called once the update has been committed to the 
 * Firebase servers
 *
 * @param value A dictionary of the keys to change and their new values
 * @param callback The callback that is triggered after the update has been written on the Firebase servers
 */
- (void) update:(NSDictionary *)value onComplete:(void (^)(NSError* error))callback;
 ...
 * @return A Firebase reference for the generated location.
 */
- (Firebase *) push:(id)value onComplete:(void (^)(NSError* error))callback;
...
- (id) on:(FEventType)eventType doCallback:(void (^) (FDataSnapshot *snapshot))callback withCancelCallback:(void (^)(void))onCancel;
...
- (id) on:(FEventType)eventType doCallbackWithPrevName:(void (^) (FDataSnapshot *snapshot, NSString *prevName))callback withCancelCallback:(void (^)(void))onCancel;
...
- (void) once:(FEventType)eventType doCallbackWithPrevName:(void (^) (FDataSnapshot *snapshot, NSString *prevName))callback withCancelCallback:(void (^)(void))onCancel;
...
- (void) authWithCredential:(NSString *)credential onComplete:(void (^) (NSError* error, id data))onComplete onCancel:(void (^)(NSError* error))onCancel;
